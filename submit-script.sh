...
spark-submit \
	...
	--simulationName $1 --nPartitions 1 --nTrain 5000 --nPnnsPerPartition 500 --nTest 2000 --nValid 2000 --batchSize 100 --nActive $2 --nInactive $3 --runGlobalRF 1 --minNodeSize 10 --globalMinNodeSize 10 --runOracle 1 --runLinear 1
