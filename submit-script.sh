...
spark-submit \
	...
	--simulationName $1 --nPartitions 4 --nPointsPerPartition 1000 --nPnnsPerPartition 500 --nTest 5000 --batchSize 100 --nActive $2 --nInactive $3 --runGlobalRF 1 --minNodeSize 25 --runOracle 1 --threshold1 .2 --threshold2 .4
