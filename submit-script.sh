...
spark-submit \
	...
	--simulationName $1 --nPartitions 4 --nPointsPerPartition 1000 --nPnnsPerPartition 500 --nTest 5000 --batchSize 100 --nActive 10 --nInactive $2 --runGlobalRF 0 --minNodeSize 25 --runOracle 0 --threshold1 .2 --threshold2 .4
